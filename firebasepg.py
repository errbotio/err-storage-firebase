...
class FirebasePlugin(StoragePluginBase):
    def __init__(self, bot_config):
        ...
        if not all (k in self._storage_config for k in (EMAIL, SECRET_ENTRY, DATA_URL_ENTRY)):
            raise Exception('You need to specify an email, a secret firebase key and a firebase data url in your config.py like this:\n'
                            'STORAGE_CONFIG={\n'
                            '"email": "foo@bar.com"\n'
                            '"secret":"4e45fd3..."\n'
